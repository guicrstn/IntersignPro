...
import { ArrowLeft, Save, Package, Wrench, Trash2 } from 'lucide-react'
    ...
    async function loadProduct() {
      ...
      if (product) {
        setFormData({
          ...
          stock_alert_threshold: product.stock_alert_threshold?.toString() || '5',
        ...
        <AlertDialog>
          ...
          <AlertDialogContent>
            <AlertDialogHeader>
              ...
              <AlertDialogDescription>
                Cette action est irreversible. L&apos;article sera definitivement supprime du catalogue.
              </AlertDialogDescription>
            </AlertDialogHeader>
            <AlertDialogFooter>
